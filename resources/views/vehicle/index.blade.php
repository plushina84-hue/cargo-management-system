...
<div class="d-flex justify-content-between align-items-center mb-4">
    <div>
        ...
        <p class="text-muted">Manage company vehicles</p>
    </div>
                ...
                @forelse($vehicles as $vehicle)
                    <tr>
                        ...
                        <td>
                            ...
                            @else
                                <span class="badge bg-secondary">{{ $vehicle->status ?? 'Inactive' }}</span>
                            @endif
                        </td>
                        <td>
                            ...
                            <form action="{{ route('vehicle.destroy', $vehicle) }}" method="POST" class="d-inline">
                                @csrf
                                @method('DELETE')
                                <button class="btn btn-sm btn-danger" onclick="return confirm('Delete vehicle?')">
